...
addLegend("topright",
    ...
    col = "#CC897E",
    title = "Carte des fêtes Antoine d'Abbadie (poètes et improvisateurs):"
  )%>%
...
addMarkers(data = Points,
           ...
           popup = ~paste(
              ...
              "<br>", "<b>", "Poètes identifiés :", "</b>", Poetes_identifies,
              "<br>", "<b>", "Sujet(s) poésie :", "</b>", Sujet_poesie,
              "<br>", "<b>", "Classement poètes :", "</b>", Resultat_poetes,
              "<br>", "<b>", "Improvisateurs identifiés :", "</b>", Improvisateurs.identifies,
              "<br>", "<b>", "Sujet(s) improvisations :", "</b>", Sujets_improvisateurs,
